...
namespace AutoMapper.ExtendedConverters.Benchmarks
{
    ...
    public static class SampleBuilder
    {
        ...
        public static T Choice<T>(this IReadOnlyList<T> items)
        {
        ...
        public static string RandomString(int size, bool digits = false)
        {
        ...
        {
            return RandomWord() + " " + String.Join(" ",
                Enumerable.Range(1, wordCount).Select(_ => Words[Random.Next(Words.Length)])
            );
        }
        
        public static List<T> RandomList<T>(int count, Func<T> factory)
        {
            return Enumerable.Range(0, count).Select(_ => factory()).ToList();
        }
        
        public static List<string> RandomStringList(int count, int stringSize, bool digits = false)
        {
            return RandomList(count, () => RandomString(stringSize, digits));
        }
